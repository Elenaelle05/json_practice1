...
// ************очищение LS***********//
// localStorage.clear()//нет аргументов.(лучше не использовать)


// ***********почему нужно всегда использовать метод JSON.stringify()
// const LS_KEY = "Array of name";
// const names = ["Alice", "Kate", "Emma"];
...
// ****LS не может сохранять функции в любой интерпритации***//
...
<li class="product-card js-product" data-product-id="${id}">
  ...
  <button class ="product-add-btn js-add">Add to Card</button>
</li>`
)
.join('');
}
